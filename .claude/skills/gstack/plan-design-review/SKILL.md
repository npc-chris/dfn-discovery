...
- Require explicit mobile behavior, loading/empty/error states, and accessibility checks.
- Avoid generic style advice; anchor recommendations to concrete DFN screens and interactions.
- Keep recommendations aligned with existing product language unless the user asks for rebrand work.

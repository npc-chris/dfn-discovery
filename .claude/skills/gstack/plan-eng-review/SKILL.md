...
## DFN Workspace Overrides (Local)

- Default posture for DFN is HOLD SCOPE unless the user explicitly asks for expansion.
- Evaluate architecture against current stack: Next.js frontend, Express backend, Drizzle/Postgres, Redis.
- Prioritize incremental delivery, rollback safety, and testability over broad redesign.
- Flag migration risk explicitly before recommending any cross-cutting structural change.
